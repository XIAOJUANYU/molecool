...
#@pytest.mark.parametrize("variable_name1, variable_name2, variable3, ...., variableN, expected_answer", 
#[variable_value1, variable_value2, variable3, ...., variableN, expected_answer1),
#[variable_value1, variable_value2, variable3, ...., variableN, expected_answer1)
#])
